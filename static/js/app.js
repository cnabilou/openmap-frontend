    ...
    var app = {
        ...
        initListeners: function() {
            ...
            self.map.on('dragend', function() {
                ...
                if(self.distanceBetween(self.currentPosition.lat, self.currentPosition.lng, self.lastCachePosition.lat, self.lastCachePosition.lng) * 1000 > 420 && self.map.getZoom() > 12.5) {
                    self.loadCache(self.currentPosition.lat, self.currentPosition.lng, function(){});
                }
            });
        },
